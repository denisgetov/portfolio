          ...
          <div class="col-xs-12 col-sm-6 col-xl-3 order-1 order-xl-2">
            <ul class="nav justify-content-center justify-content-sm-end">
             <li class="nav-item">
              ...
              <li class="nav-item">
  <a class="nav-link link-dark px-3" href="mailto:your-email@example.com">
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-envelope" viewBox="0 0 16 16">
    <path d="M14.183,2H1.817C1.375,2,1,2.375,1,2.817v10.366C1,13.625,1.375,14,1.817,14h12.366c0.442,0,0.817-0.375,0.817-0.817V2.817C15,2.375,14.625,2,14.183,2z M13.465,3.005L8.728,7.561c-0.187,0.156-0.493,0.156-0.68,0L2.537,3.005H13.465z M1.989,12.561l3.128-2.62L1.643,7.585L1.989,12.561z M2.631,11.438L4.95,9.204l1.721,1.438c0.445,0.372,1.091,0.372,1.537,0l1.72-1.438l2.319,2.234H2.631z M12.359,11.438L9.8,9.328l3.527-0.002L12.359,11.438z M12.35,10.328l-1.25,1.21l1.25,1.229V10.328z"/>
    </svg>
  </a>
</li>
